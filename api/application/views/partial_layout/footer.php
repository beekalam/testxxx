...
<script src="<?php echo base_url() ?>assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js"
        type="text/javascript"></script>
<script src="<?php echo base_url() ?>assets/pages/scripts/table-datatables-scroller.min.js"
        type="text/javascript"></script>
...
<!--<script src="-->
<?php //echo base_url() ?><!--assets/global/plugins/bootstrap-sweetalert/sweetalert.min.js"></script>-->
<!-- sweetalert.all does not need the css file -->
